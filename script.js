...
function getSelectedValue(){
  ...
  searchInput1.addEventListener("input", e =>{
    value1 = e.target.value1.toLowerCase()
    console.log(value1);
    countrynamefromstate1 = getCountryByState(value1);
  })
  searchInput2.addEventListener("input", e =>{
    value2 = e.target.value2.toLowerCase()
    console.log(value2);
    countrynamefromstate2 = getCountryByState(value2);
  })
 var selectedValue = document.getElementById('select').value1;
...
searchInput1.addEventListener("input", e =>{
  ...
  newArray = array.filter((array)=>
  {
    ...
    || array.country.includes(countrynamefromstate)||array.skills.includes(value)||array.title.includes(value)||array.type.includes(value)||array.country.includes(value))&&array.select.includes(selectedValue.toLowerCase())) && array.select.includes(selectedValue.toLowerCase()))
  })
  givejobs(newArray);
